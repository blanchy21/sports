...
export function serializePrediction(
  ...
  const bite: PredictionBite = {
    ...
    proposedOutcomeId: prediction.proposedOutcomeId,
    proposedBy: prediction.proposedBy,
    proposedAt: prediction.proposedAt?.toISOString() ?? null,
    proposedAction: prediction.proposedAction,
    proposedVoidReason: prediction.proposedVoidReason,
