...
import { PredictionComposer } from '@/components/sportsbites/PredictionComposer';
import {
  SPORTSBITES_CONFIG,
          ...
          <div className="flex items-center justify-between border-t bg-muted/30 px-4 py-3">
            <div className="flex items-center gap-1">
              ...
              <div className="relative">
                <Button
                  ...
                  className="h-9 w-9 p-0 text-muted-foreground hover:bg-purple-500/10 hover:text-purple-500"
                  title="Add GIF"
                >
              ...
              <div className="relative">
                <Button
                  ...
                  className="h-9 w-9 p-0 text-muted-foreground hover:bg-warning/10 hover:text-warning"
                  title="Tag sport"
                >
              ...
              <Button
                ...
                className={cn(
                  ...
                  poll ? 'text-primary' : 'text-muted-foreground hover:text-primary'
                )}
            ...
            <div className="flex items-center gap-3">
              ...
              <Button
                ...
                disabled={!canPublish}
                className={cn('rounded-full px-6 font-bold', !user && 'opacity-50')}
              >
                {isPublishing ? (
                  <>
