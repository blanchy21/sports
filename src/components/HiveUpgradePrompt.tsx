...
export const HiveUpgradePrompt: React.FC<HiveUpgradePromptProps> = ({
  ...
  return (
    <div className={cn(
      ...
      <div className="bg-card border rounded-lg shadow-lg max-w-md w-full mx-4 p-6 relative">
        <button
          onClick={onClose}
        ...
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-6">
            To {action} this Hive post, you need to connect a Hive wallet.
            Hive posts are stored on the blockchain and require a wallet for interactions.
          </p>
...
export const useHiveUpgradePrompt = () => {
  ...
  const showPromptIfNeeded = useCallback((action: string = "interact with"): boolean => {
