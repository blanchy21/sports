...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="hidden lg:flex lg:flex-col lg:w-64 xl:w-80 lg:fixed lg:inset-y-0 lg:pt-20 xl:pt-24 lg:pb-4 lg:overflow-y-auto lg:border-r bg-background">
