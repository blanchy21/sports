    ...
    <div className="space-y-4">
      ...
      {step === 'golfers' && (
        <div className="space-y-3">
          <p className="text-sm text-muted-foreground">
            Pick 3 golfers. Combined odds must be at least {GOLF_FANTASY_CONFIG.MIN_COMBINED_ODDS}
            /1.
          </p>
          ...
          >
            ...
            <div className="text-xl font-bold">{combinedOdds}/1</div>
      ...
      {step === 'tiebreaker' && (
        <div className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Predict the winning score (relative to par). For example, -12 means 12 under par. This
      ...
      {step === 'confirm' && !confirmMutation.isSuccess && (
        <div className="space-y-4">
          ...
          <div className="text-xs text-muted-foreground">
            ...
            <strong>{Number(tieBreaker) >= 0 ? `+${tieBreaker}` : tieBreaker}</strong> (relative to
            par)
          </div>
