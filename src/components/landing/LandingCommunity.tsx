...
export default function LandingCommunity({ sports }: LandingCommunityProps) {
  return (
    <>
      ...
      <section className="bg-sb-turf/30 px-6 py-24">
        <div className="mx-auto max-w-6xl">
            ...
            {sports.map((sport, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 flex items-end p-4 sm:p-6">
                  <h3 className="font-display text-lg font-bold text-white drop-shadow-lg sm:text-xl md:text-2xl">
                    {sport.name}
                  </h3>
                </div>
              </motion.div>
          ...
          <motion.p
            ...
            className="mt-10 text-center text-sb-text-muted"
          >
      ...
      <section className="bg-gradient-to-b from-sb-pitch/5 to-background px-6 py-24">
        <div className="mx-auto max-w-5xl">
          ...
          >
            {[
              ...
              <motion.div
                ...
                className="rounded-2xl border bg-sb-stadium p-8 text-center transition-all duration-300 hover:shadow-xl hover:shadow-sb-teal/5"
              >
                ...
                <p className="leading-relaxed text-sb-text-muted">{item.description}</p>
              </motion.div>
            ))}
          </motion.div>
          ...
          >
            <p className="mb-6 text-sm font-medium text-sb-text-muted">
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 sm:gap-12">
              {[
                ...
                >
                  ...
                  <span className="text-xs text-sb-text-muted">{wallet.label}</span>
                </motion.div>
              ))}
            </div>
          </motion.div>
