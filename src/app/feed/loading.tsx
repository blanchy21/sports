        ...
        <div className="mx-auto max-w-4xl space-y-6 px-6 py-6">
          ...
          <div className="animate-pulse rounded-lg border bg-sb-stadium p-4">
            <div className="flex items-center space-x-3">
              ...
              <div className="h-10 flex-1 rounded-lg bg-sb-turf" />
              <div className="h-10 w-20 rounded-lg bg-sb-turf" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            {Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="animate-pulse rounded-lg border bg-sb-stadium p-4">
                <div className="flex items-center space-x-3">
                  <div className="h-9 w-9 rounded-lg bg-sb-turf p-2" />
                  <div className="flex-1">
                    <div className="mb-1 h-8 w-16 rounded bg-sb-turf" />
          ...
          <div className="flex items-center justify-between">
            <div className="h-7 w-36 animate-pulse rounded bg-sb-turf" />
            <div className="h-9 w-20 animate-pulse rounded bg-sb-turf" />
          </div>
