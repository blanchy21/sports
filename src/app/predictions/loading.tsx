      ...
      <div className="mx-auto max-w-2xl space-y-4 px-4 py-6">
        ...
        <div className="flex gap-2">
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="h-8 w-20 animate-pulse rounded-full bg-sb-turf" />
          ))}
        </div>
          ...
          <div key={i} className="animate-pulse rounded-xl border bg-sb-stadium p-4">
            <div className="flex gap-3">
              ...
              <div className="flex-1 space-y-3">
                ...
                <div className="h-5 w-3/4 rounded bg-sb-turf" />
                <div className="space-y-2">
                  <div className="h-8 w-full rounded bg-sb-turf" />
                  <div className="h-8 w-full rounded bg-sb-turf" />
                </div>
              </div>
            </div>
