...
export async function GET(request: NextRequest) {
  // Only allow in development — blocks production reconnaissance
  ...
  const results: { timestamp: string; tests: Record<string, unknown> } = {
        ...
        results.tests = {
          ...
          initialization: {
            ...
            isRequestInterceptor:
              error instanceof Error && error.message.includes('requestInterceptor'),
          },
        };
      }
    }
