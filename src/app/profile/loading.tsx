        ...
        <div className="mx-auto max-w-4xl space-y-6 px-6 py-6">
          ...
          <div className="animate-pulse rounded-lg border bg-sb-stadium p-6">
            <div className="flex flex-col items-start gap-6 md:flex-row">
              <div className="h-24 w-24 rounded-full bg-sb-turf" />
              <div className="flex-1">
                <div className="mb-2 h-8 w-48 rounded bg-sb-turf" />
                <div className="mb-4 h-4 w-32 rounded bg-sb-turf" />
                <div className="mb-4 h-16 w-full rounded bg-sb-turf" />
              ...
              <div className="h-10 w-28 rounded bg-sb-turf" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="animate-pulse rounded-lg border bg-sb-stadium p-4">
                <div className="mb-2 h-4 w-16 rounded bg-sb-turf" />
                <div className="h-8 w-12 rounded bg-sb-turf" />
              </div>
            ))}
          </div>
          ...
          <div>
            <div className="mb-4 h-6 w-24 animate-pulse rounded bg-sb-turf" />
